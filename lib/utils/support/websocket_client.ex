defmodule Phelper.WebsocketClient do
  @moduledoc """
  A WebSocket client used to test Phoenix.Channel

  iex(10)> {:ok, p} = Phelper.WebsocketClient.connect self(), "ws://localhost:4000/ws/echo/websocket", Phoenix.Socket.V2.JSONSerializer
  {:ok, #PID<0.1017.0>}
  iex(11)> Phelper.WebsocketClient.send_heartbeat p
  """
